...
- [Python os.get_terminal_size()](https://www.w3schools.com/python/ref_os_get_terminal_size.asp#:~:text=Python%20os.,-get_terminal_size()%20Method&text=get_terminal_size()%20return%20the%20sizee,the%20terminal%20window%20in%20characters.)
